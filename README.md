...
- **자동 화자 클론의 크로스링구얼 명료도** — 원본(타 언어·배경 섞임)에서 추출한 ref로 클론하면 타깃어 발음이 불명료해짐(라운드트립 ASR 검증: 더빙 영어가 한/영 혼동으로 인식). **명료한 더빙엔 전용 보이스 샘플 권장**. 깨끗한 영어 샘플 사용 시 재인식이 의도 텍스트와 거의 일치.
