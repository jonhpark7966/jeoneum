...
> ⏸️ **WIP / 보류 (2026-06-02).** 아래 절차는 정상 동작하지만, **더빙 음성 품질이 실사용 기준에 미달**(크로스링구얼 클론 억양 문제, 다화자 붕괴)하여 프로젝트는 보류 상태입니다. 배경·마지막 테스트 결과·재작업 방향은 [README 최상단 "WIP — 작업 보류" 섹션](../README.md)을 참조하세요. 이하 "동작함" 설명은 **기능 동작을 의미하며 출력 품질을 보증하지 않습니다.**
